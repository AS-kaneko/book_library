...
const Toast: React.FC<ToastProps> = ({ message, type, onClose, duration = 3000 }) => {
  ...
  return (
    <div
      ...
      aria-atomic="true"
      className={`
        flex items-center justify-between px-5 py-4 rounded-lg shadow-lg border-l-4
    ...
    >
      ...
      <button
        onClick={handleClose}
        className="ml-4 flex-shrink-0 text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent rounded-md p-1 transition-colors"
        aria-label="通知を閉じる"
      >
