...
## - [x] 4. BookManagementPageのテキストリソース適用
...
## - [x] 5. LoanManagementPageのテキストリソース適用
...
## - [x] 6. EmployeeManagementPageのテキストリソース適用
...
## - [x]* 9. テキストリソースのプロパティテストを作成

テキストリソースの完全性と正確性を検証するプロパティテストを作成します。

### - [x]* 9.1 プロパティ1: テキストリソースの完全性
...
## - [x]* 10. モード切替とナビゲーションのプロパティテストを作成

モード切替とナビゲーション表示制御の正確性を検証するプロパティテストを作成します。

### - [x]* 10.1 プロパティ7: モード切替の動作
...
## - [x]* 11. 機能の同等性のプロパティテストを作成

キッズモードと通常モードで同じ機能が動作することを検証するプロパティテストを作成します。

### - [x]* 11.1 プロパティ10: 機能の同等性
...
## - [x]* 12. ビジュアルテーマのプロパティテストを作成

キッズモード時のビジュアルテーマが正しく適用されることを検証するプロパティテストを作成します。

### - [x]* 12.1 プロパティ9: ビジュアルテーマの適用
